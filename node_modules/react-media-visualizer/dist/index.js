...
var AudioControls = function AudioControls(props) {
  return React__default.createElement(
    ...
    React__default.createElement(
      ...
      props.theme === 'spotify' && React__default.createElement('i', { className: 'fa fa-random' }),
      React__default.createElement('i', { onClick: props.goPreviousSong, className: 'fa fa-step-backward' }),
      props.theme === 'spotify' ? props.playlistIsPlaying ? React__default.createElement('i', { onClick: function onClick() {
          return props.updateIsPlaying();
        }, className: 'fa fa-pause-circle fa-2x' }) : React__default.createElement('i', { onClick: function onClick() {
          return props.updateIsPlaying();
        }, className: 'fa fa-play-circle fa-2x' }) : null,
      props.theme === 'soundcloud' ? props.playlistIsPlaying ? React__default.createElement('i', { onClick: function onClick() {
          return props.updateIsPlaying();
        }, className: 'fa fa-pause' }) : React__default.createElement('i', { onClick: function onClick() {
          return props.updateIsPlaying();
        }, className: 'fa fa-play' }) : null,
      props.theme === 'youtube' ? props.playlistIsPlaying ? React__default.createElement('i', { onClick: function onClick() {
          return props.updateIsPlaying();
        }, style: youtubeFontAwesome, className: 'fa fa-pause fa-lg' }) : React__default.createElement('i', { onClick: function onClick() {
          return props.updateIsPlaying();
        }, style: youtubeFontAwesome, className: 'fa fa-play fa-lg' }) : null,
      React__default.createElement('i', { onClick: props.goNextSong, className: 'fa fa-step-forward' }),
      props.theme === 'spotify' && React__default.createElement('i', { className: 'fa fa-redo' }),
      props.theme === 'soundcloud' && React__default.createElement(
        React__default.Fragment,
        null,
        React__default.createElement('i', { className: 'fa fa-random' }),
        React__default.createElement('i', { className: 'fa fa-redo' })
      )
    ),
    React__default.createElement(
      'div',
      { className: props.styles.songTime },
      props.theme === 'youtube' && props.audioControls.songTime && React__default.createElement(
        'span',
        null,
  ...
  createClass$1(VolumeSlider, [{
    ...
    value: function render() {
      return React__default.createElement(
        ...
        this.props.theme === 'spotify' || this.props.theme === 'youtube' ? this.state.hoverVolume && React__default.createElement(
          React__default.Fragment,
          null,
          React__default.createElement('i', { className: 'fa fa-volume-off' }),
          React__default.createElement(Slider$1, { min: 0, max: 100, defaultValue: this.props.volumeLevel, onChange: this.props.updateVolumeLevel, style: style$1 })
        ) : null,
        this.props.theme === 'soundcloud' ? this.state.hoverVolume && React__default.createElement(
          'div',
          { className: this.props.styles.slider__background },
          React__default.createElement(Slider$1, { vertical: true, min: 0, max: 100, trackStyle: { backgroundColor: '#f50', height: 10 }, handleStyle: { borderColor: '#f50', backgroundColor: '#f50' }, railStyle: { backgroundColor: '#ccc' }, defaultValue: this.props.volumeLevel, onChange: this.props.updateVolumeLevel, style: soundcloudStyle })
        ) : null,
        React__default.createElement('i', { className: 'fa fa-volume-up', onMouseEnter: this.mouseEnter })
      );
    }
  }]);
  return VolumeSlider;
...
var SpotifyPlaylist = function SpotifyPlaylist(props) {
  return props.metaPlaylist && props.metaPlaylist[0] ? React__default.createElement(
    'div',
          ...
          props.metaPlaylist.map(function (song, index) {
            return React__default.createElement(
              ...
              React__default.createElement(
                ...
                props.currentSongIndex === index ? props.playlistIsPlaying ? React__default.createElement(
                  'span',
                  { onClick: function onClick() {
                      return props.updateIsPlaying();
                    } },
                  React__default.createElement('i', { className: 'fa fa-pause fa-xs' })
                ) : React__default.createElement(
                  'span',
                  { onClick: function onClick() {
                      return props.updateIsPlaying();
                    } },
                  React__default.createElement('i', { className: 'fa fa-play fa-xs' })
                ) : React__default.createElement(
                  'span',
                  { onClick: function onClick() {
              ...
              props.currentSongIndex === index ? React__default.createElement(
                'div',
                { onClick: function onClick() {
                    return props.updateIsPlaying();
                  }, className: props.styles.songName },
...
var MediaToggles = function MediaToggles(props) {
  ...
  var getThemePlaylist = function getThemePlaylist(props) {
    switch (props.theme) {
      case 'spotify':
        return React__default.createElement(SpotifyPlaylist, {
          styles: props.styles,
      ...
      case 'soundcloud':
        return React__default.createElement(SoundcloudPlaylist, {
          styles: props.styles,
          metaPlaylist: props.metaPlaylist,
          currentSongIndex: props.currentSongIndex,
          updateIsPlaying: props.updateIsPlaying,
  ...
  return React__default.createElement(
    ...
    props.showVolumeBar ? React__default.createElement(VolumeSlider, { theme: props.theme, styles: props.styles, volumeLevel: props.volumeLevel, updateVolumeLevel: props.updateVolumeLevel }) : null,
    props.showPlaylistToggle ? React__default.createElement(
      React__default.Fragment,
      null,
      props.showPlaylist ? getThemePlaylist(props) : null,
      React__default.createElement('i', { className: 'fa fa-list-ol', style: _extends$3({}, fabStyle, { color: highlightColor(props.showPlaylist) }), onClick: function onClick() {
          return props.updateToggles('showPlaylist');
        } })
    ) : null,
    props.showVisualizerToggle ? React__default.createElement('i', { className: 'fab fa-react', style: _extends$3({}, fabStyle, { color: highlightColor(props.showVisualizer) }), onClick: function onClick() {
...
var AudioMeta = function AudioMeta(props) {
  if (props.metaPlaylist && Number.isInteger(props.currentSongIndex) && props.metaPlaylist[props.currentSongIndex]) {
    return React__default.createElement(
      ...
      React__default.createElement(
        ...
        React__default.createElement('img', { src: props.metaPlaylist[props.currentSongIndex].picture, alt: props.metaPlaylist[props.currentSongIndex].title })
      ),
      React__default.createElement(
        'div',
        ...
        React__default.createElement(
          ...
          (props.theme === 'spotify' || props.theme === 'soundcloud') && React__default.createElement(
            'span',
            null,
            props.metaPlaylist[props.currentSongIndex].artist,
            ' '
          ),
          props.theme === 'youtube' && React__default.createElement(
            'span',
            null,
            props.metaPlaylist[props.currentSongIndex].artist,
            ' \u2022 ',
  ...
  } else return React__default.createElement('div', { className: props.styles.meta });
};
    ...
    React__default.createElement(
      ...
      React__default.createElement(
        ...
        React__default.createElement(
          ...
          React__default.createElement('img', { src: props.metaPlaylist[props.currentSongIndex].picture })
        )
      ),
      React__default.createElement(
        'div',
...
function getThemePlaylist(props) {
  switch (props.theme) {
    case 'youtube':
      return React__default.createElement(YoutubePlaylist, {
        styles: props.styles,
        metaPlaylist: props.metaPlaylist,
        currentSongIndex: props.currentSongIndex,
        updateIsPlaying: props.updateIsPlaying,
  ...
  createClass$1(Barred, [{
    ...
    value: function setUpScene() {
      ...
      for (var i = 0; i < numBars; i++) {
        var geometry = new THREE.PlaneBufferGeometry(18, 0, 1);
        var uniforms = {};
...
function setUniformColor(I, h, s, l, factor) {
  group$1.children[I].material.uniforms.col.value = new THREE.Color('hsl(' + h + ', ' + s + '%, ' + l + '%)');
...
var Tricentric = function () {
  ...
  createClass$1(Tricentric, [{
    ...
    key: 'setUpScene',
    value: function setUpScene() {
      group$1 = new THREE.Object3D();
      var positionZ = 498;

      for (var i = 0; i < numBars$1; i++, positionZ -= 5) {
        var geometry = new THREE.CylinderBufferGeometry(20, 20, 2, 3, 1, true);
        var uniforms = {
...
var Flower = function () {
  ...
  createClass$1(Flower, [{
    ...
    value: function setUpScene() {
      ...
      for (var i = 0; i <= 2048; i++) {
        var particle = particles$1[i++] = new THREE.Mesh(geometry, material);
        this.scene.add(particle);
      }
    }
  }, {
...
var AudioVisualizer = function (_Component) {
  ...
  createClass$1(AudioVisualizer, [{
    ...
    key: 'render',
    value: function render() {
      return React__default.createElement('div', { className: this.props.styles.visualizer, ref: this.canvasRef });
    }
  }, {
    ...
    value: function render() {
      return React__default.createElement(
        ...
        React__default.createElement(
          ...
          (this.props.theme === 'spotify' || this.props.theme === 'soundcloud') && React__default.createElement(
            'div',
          ...
          React__default.createElement(
            ...
            React__default.createElement('div', { className: this.props.styles.progress__bar__percent, style: { 'width': this.props.audioControls.songPercent * 100 + '%' } }),
            React__default.createElement('div', { onClick: this.props.updateAudioTime, className: this.props.styles.progress__bar__translucent })
          ),
          (this.props.theme === 'spotify' || this.props.theme === 'soundcloud') && React__default.createElement(
            'div',
...
var ReactMediaVisualizer = function (_Component) {
  ...
  function ReactMediaVisualizer(props) {
    ...
    _this.reactAudioPlayer = React__default.createRef();
  ...
  createClass$1(ReactMediaVisualizer, [{
    ...
    value: function render() {
      return React__default.createElement(
        React__default.Fragment,
        null,
        this.state.showVisualizer && React__default.createElement(AudioVisualizer, { styles: this.state.styles, showVisualizer: this.state.showVisualizer, audioAnalyser: this.state.audioAnalyser }),
        this.props.playlist ? React__default.createElement(
          'div',
          { className: this.state.styles.av__background },
          React__default.createElement(
            'div',
            { className: this.state.styles.av__container },
            React__default.createElement(AudioControls, { styles: this.state.styles, audioControls: this.state.audioControls, theme: this.props.theme, playlistIsPlaying: this.state.playlistIsPlaying, updateAudioTime: this.updateAudioTime, goPreviousSong: this.goPreviousSong, updateIsPlaying: this.updateIsPlaying, goNextSong: this.goNextSong, playlist: this.props.playlist }),
            React__default.createElement(AudioDuration, { styles: this.state.styles, theme: this.props.theme, updateAudioTime: this.updateAudioTime, audioControls: this.state.audioControls }),
            React__default.createElement(AudioMeta, { styles: this.state.styles, theme: this.props.theme, metaPlaylist: this.state.metaPlaylist, currentSongIndex: this.state.currentSongIndex }),
            React__default.createElement('audio', { src: this.props.playlist[this.state.currentSongIndex], ref: this.reactAudioPlayer, onTimeUpdate: this.onTimeUpdateListener, onEnded: this.goNextSong }),
            React__default.createElement(MediaToggles, { theme: this.props.theme, updateIsPlaying: this.updateIsPlaying, currentSongIndex: this.state.currentSongIndex, playlistIsPlaying: this.state.playlistIsPlaying, selectSongFromPlaylist: this.selectSongFromPlaylist, styles: this.state.styles, metaPlaylist: this.state.metaPlaylist, showPlaylistToggle: this.props.showPlaylistToggle, showPlaylist: this.state.showPlaylist, showVisualizer: this.state.showVisualizer, showVolumeBar: this.props.showVolumeBar, showVisualizerToggle: this.props.showVisualizerToggle, volumeLevel: this.state.volumeLevel, updateVolumeLevel: this.updateVolumeLevel, updateToggles: this.updateToggles })
          )
        ) : React__default.createElement('div', null),
        React__default.createElement(AudioPlaylist, { styles: this.state.styles, theme: this.props.theme, selectSongFromPlaylist: this.selectSongFromPlaylist, updateIsPlaying: this.updateIsPlaying, showPlaylist: this.state.showPlaylist, metaPlaylist: this.state.metaPlaylist, currentSongIndex: this.state.currentSongIndex, playlistIsPlaying: this.state.playlistIsPlaying })
      );
    }
  }, {
    key: 'goPreviousSong',
...
module.exports = ReactMediaVisualizer;
