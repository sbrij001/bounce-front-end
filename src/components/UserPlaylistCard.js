...
import CardCSS from 'src/style/CardCSS.css'

class UserPlaylistCard extends React.Component{
  state = {
    clicked: false
  }
...
// in app I pass that currentPlaylist to the songList
  ...
  render(){
    console.log('UserPlaylistCard',this.props.playlist);
    return(
...
export default withRouter(UserPlaylistCard);
